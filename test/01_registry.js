...
contract('Registry', function (accounts) {
    ...
    it("setNode allows operator to add their node", async () => {
      const domain = "https://node.scn.org"
    ...
    it("setNodeRaw allows operator to add their node", async () => {
      ...
      const domain = "https://node2.scn.org"
    ...
    it("setNode allows operator to update their node", async () => {
      ...
      const domain2 = "https://node2.scn.org"
    ...
    it("getNodeOperators", async () => {
      const domains = ["https://node.scn.org", "https://node2.scn.org", "https://node3.scn.org"]
    ...
    it("setParty allows listing scpi party", async () => {
      const domain = "https://node.scn.org"
      await registry.setNode(domain, {from: accounts[1]})
    ...
    it("setParty allows updating scpi party", async () => {
      const domain = "https://node.provider.net"
      await registry.setNode("https://node.scn.org", {from: accounts[1]})
      await registry.setNode(domain, {from: accounts[3]})
    ...
    it("setPartyModules allows setting of scpi module implementations", async () => {
      const domain = "https://node.scn.org"
      await registry.setNode(domain, {from: accounts[1]})
